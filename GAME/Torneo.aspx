        ...
        <ContentTemplate>
                    ...
                    <ContentTemplate>
                      <div class="VS">  
                        <div><!--UNO-->
                            ...
                            <div class="Linea"></div>
                            <asp:Button ID="D_UB_1_1" runat="server" Text="2" class="Opciones" OnClick="D_UB_1_1_Click1" /><asp:Button ID="D_UB_1_2" runat="server" Text="2" class="Opciones" OnClick="D_UB_1_2_Click"/><asp:Button ID="D_UB_1_3" runat="server" Text="3" class="Opciones"/>
                        </div>
                        <div><!--DOS-->
                      ...
                      <div class="VS"> 
                        <div><!--TRES-->
                            ...
                            <div class="Linea"></div>
                            <asp:Button ID="D_UB_3_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_UB_3_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_UB_3_3" runat="server" Text="3" class="Opciones"/>
                        </div>
                        <div><!--CUATRO-->
                        ...
                        <div><!--CINCO-->
                            ...
                            <div class="Linea"></div>
                            <asp:Button ID="D_UB_5_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_UB_5_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_UB_5_3" runat="server" Text="3" class="Opciones"/>
                        </div>
                        <div><!--SEIS-->
                        ...
                        <div><!--SIETE-->
                            ...
                            <div class="Linea"></div>
                            <asp:Button ID="D_UB_7_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_UB_7_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_UB_7_3" runat="server" Text="3" class="Opciones"/>
                        </div>
                        <div><!--OCHO-->
            ...
            <div class="Ronda">
                ...
                <div><!--UNO-->
                    ...
                    <div class="Linea"></div>
                    <asp:Button ID="D_DB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_DB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_DB_1_3" runat="server" Text="3" class="Opciones"/>
                </div>
                <div><!--DOS-->
                ...
                <div><!--TRES-->
                    ...
                    <div class="Linea"></div>
                    <asp:Button ID="D_DB_3_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_DB_3_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_DB_3_3" runat="server" Text="3" class="Opciones"/>
                </div>
                <div><!--CUATRO-->
            ...
            <div class="Ronda">
                ...
                <div><!--UNO-->
                    ...
                    <div class="Linea"></div>
                    <asp:Button ID="D_TB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_TB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_TB_1_3" runat="server" Text="3" class="Opciones"/>
                </div>
                <div><!--DOS-->
            ...
            <div class="Ronda" >
                ...
                <div><!--UNO-->
                    ...
                    <div class="Linea"></div>
                    <asp:Button ID="D_CB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="D_CB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="D_CB_1_3" runat="server" Text="3" class="Opciones"/>
                </div>
                </div>
            </div>
            <!--/
            ...
            <div class="Ronda" >
              ...
              <div><!--UNO-->
                  ...
                  <div class="Linea"></div>
                  <asp:Button ID="I_CB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_CB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_CB_1_3" runat="server" Text="3" class="Opciones"/>
              </div>
            </div>
            <!--NUMERO DOS-->
            <div class="Ronda" >
              ...
              <div><!--UNO-->
                  ...
                  <div class="Linea"></div>
                  <asp:Button ID="I_TB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_TB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_TB_1_3" runat="server" Text="3" class="Opciones"/>
              </div>
              <div><!--DOS-->
            ...
            <div class="Ronda" > 
              ...
              <div><!--UNO-->
                  ...
                  <div class="Linea"></div>
                    <asp:Button ID="I_DB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_DB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_DB_1_3" runat="server" Text="3" class="Opciones"/>
              </div>
              <div><!--DOS-->
              ...
              <div><!--TRES-->
                  ...
                  <div class="Linea"></div>
                  <asp:Button ID="I_DB_3_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_DB_3_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_DB_3_3" runat="server" Text="3" class="Opciones"/>
              </div>
              <div><!--CUATRO-->
                    ...
                    <ContentTemplate>
                      <div class="VS">
                        <div><!--UNO-->
                              ...
                              <div class="Linea"></div>
                              <asp:Button ID="I_UB_1_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_UB_1_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_UB_1_3" runat="server" Text="3" class="Opciones"/>
                          </div>
                          <div><!--DOS-->
                          ...
                          <div><!--TRES-->
                              ...
                              <div class="Linea"></div>
                              <asp:Button ID="I_UB_3_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_UB_3_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_UB_3_3" runat="server" Text="3" class="Opciones"/>
                          </div>
                          <div><!--CUATRO-->
                          ...
                          <div><!--CINCO-->
                              ...
                              <div class="Linea"></div>
                              <asp:Button ID="I_UB_5_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_UB_5_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_UB_5_3" runat="server" Text="3" class="Opciones"/>
                          </div>
                          <div><!--SEIS-->
                          ...
                          <div><!--SIETE-->
                              ...
                              <div class="Linea"></div>
                              <asp:Button ID="I_UB_7_1" runat="server" Text="1" class="Opciones"/><asp:Button ID="I_UB_7_2" runat="server" Text="2" class="Opciones"/><asp:Button ID="I_UB_7_3" runat="server" Text="3" class="Opciones"/>
                          </div>
                          <div><!--OCHO-->
